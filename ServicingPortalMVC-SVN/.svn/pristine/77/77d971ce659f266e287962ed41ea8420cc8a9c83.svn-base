				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="vpc_ReturnURL" size="50"
							value="http://localhost:8080/PortalServiceMVC/dr" maxlength="250" /></td>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="vpc_SHIP_Country"
							value="${OrderNote}" size="30" maxlength="50" /></td>
					...
					<tr>
						...
						<td><input type="text" name="vpc_Customer_Email" size="30"
							value="${cusProfile.getCustomerEmail()}" maxlength="50" /></td>
						<td>Địa chỉ hòm thư của khách hàng</td>
					</tr>
					<tr>
						<td><strong><em>Customer User Id</em></strong></td>
						<td><input type="text" name="vpc_Customer_Id" value="${cusProfile.getCustomerFullName()}"
							size="30" maxlength="50" /></td>
