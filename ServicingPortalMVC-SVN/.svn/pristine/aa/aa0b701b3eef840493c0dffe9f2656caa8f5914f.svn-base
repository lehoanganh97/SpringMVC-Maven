...
<meta
	...
	name="viewport">
<!-- Bootstrap 3.3.4 -->
<link href="resources/partner/bootstrap/css/bootstrap.min.css"
...
<link
	...
	rel="stylesheet" type="text/css" />
<!-- Theme style -->
<link href="resources/partner/dist/css/AdminLTE.min.css"
	rel="stylesheet" type="text/css" />
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
<link href="resources/partner/dist/css/skins/skin-blue.min.css"
	rel="stylesheet" type="text/css" />
...
<body class="skin-blue sidebar-mini">
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									alt="User Image" />
									<p>
										${cusProfile.getCustomerFullName()} <small>Thành viên
											từ 11/2012</small>
									</p></li>
								<!-- Menu Body -->
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="resources/partner/dist/img/user2-160x160.jpg"
							class="img-circle" alt="User Image" />
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview active"><a href="#"><i
							class="fa fa-list"></i> <span>Danh sách đơn hàng</span> <i
							class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li class="active"><a href="viewCustomerOrder.jsp"><i
									class="fa fa-calendar-o"></i> <span>Thực hiện</span></a></li>
							<li><a href="viewCustomerOrderComplete.jsp"><i
													...
													<thead>
														<tr role="row">
															...
															<th class="sorting" tabindex="0" aria-controls="example1"
																...
																aria-label="Browser: activate to sort column ascending">Create
																Date</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
															...
															<th class="sorting" tabindex="0" aria-controls="example1"
																...
																aria-label="CSS grade: activate to sort column ascending">Note</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1" style="width: 110px;"
													...
													<tbody>
														...
														<c:forEach items="${lsOrderServices}" var="orderService"
															...
															<tr role="row" class="odd">
																<td><c:out value="${orderService.getOrderId()}" /></td>
																<td><c:out value="${orderService.getCreateDate()}" /></td>
																<td><c:out
																		value="${orderService.getOrderTotalPrice() }" /></td>
																<td id="o-stt-${loop.index}">${orderService.getOrderStatus()}</td>
																...
																<td>
																	<form
																		...
																		method="POST">
																		<input type="hidden"
																			value="${orderService.getOrderId()}" name="OrderID" />
																		<input type="hidden"
																			value="${orderService.getOrderTotalPrice()*100}"
										...
										<div class="row">
											<div class="col-sm-5">
												<div class="dataTables_info" id="example1_info"
													...
													${lsOrderServices.size()} entries</div>
											</div>
											<div class="col-sm-7">
												<div class="dataTables_paginate paging_simple_numbers"
													...
													<ul class="pagination">
														...
														<li class="paginate_button "><a href="#"
															aria-controls="example1" data-dt-idx="2" tabindex="0">2</a>
														</li>
														<li class="paginate_button "><a href="#"
															aria-controls="example1" data-dt-idx="3" tabindex="0">3</a>
														</li>
														<li class="paginate_button "><a href="#"
															aria-controls="example1" data-dt-idx="4" tabindex="0">4</a>
														</li>
														<li class="paginate_button "><a href="#"
															aria-controls="example1" data-dt-idx="5" tabindex="0">5</a>
														</li>
														<li class="paginate_button "><a href="#"
	...
	<!-- jQuery 2.1.4 -->
	<script src="resources/partner/plugins/jQuery/jQuery-2.1.4.min.js"
		type="text/javascript"></script>
	<!-- Bootstrap 3.3.2 JS -->
	<script src="resources/partner/bootstrap/js/bootstrap.min.js"
		type="text/javascript"></script>
	<!-- AdminLTE App -->
	<script src="resources/partner/dist/js/app.min.js"
		type="text/javascript"></script>
	<script src="resources/customer/js/my-script.js" type="text/javascript"></script>
