          ...
          <ul class="sidebar-menu">          
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="MyServicePost"><i class="fa fa-list"></i>Danh sách dịch vụ</a></li>
                <li><a href="AddServicePost"><i class="fa fa-plus-circle"></i>Thêm mới dịch vụ</a></li>
              </ul>
            </li>         
            <li class="treeview">
              <a href="#"><i class="fa fa-list"></i> <span>Danh sách đơn hàng</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="OrderWaiting"><i class="fa fa-calendar-o"></i> <span>Chờ xác nhận</span></a></li>
                <li><a href="OrderInProcess"><i class="fa fa-motorcycle"></i> <span>Đang xử lý</span></a></li>
                <li><a href="OrderComplete"><i class="fa fa-check"></i> <span>Đã hoàn thành</span></a></li>
                <li><a href="OrderCancel"><i class="fa fa-remove"></i> <span>Đã hủy</span></a></li>
              </ul>              
            </li>            
      <li class="treeview">
            ...
            <li><a href="Invoice"><i class="fa fa-money"></i> <span>Thu nhập</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      </aside>
