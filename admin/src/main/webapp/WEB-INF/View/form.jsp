  ...
  <div class="col-md-offset-2 col-md-7">
   ...
   <div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <form:form action="test" cssClass="form-horizontal"  method="post" modelAttribute="staff"> <%-- modelAttribute="staff"> --%>
				...
				<!-- Roles to select -->
                    <div class="input-group mb-3">
			           ...
			           <%--  <form:select path="role.roleId">
						    ...
						    <form:options items="${roles}" itemValue="${role.getRoleId()}" itemLabel="${role.getRoleName()}" />
						</form:select>   --%>
