  ...
  <div class="col-md-offset-1 col-md-10">
   ...
   <div class="panel panel-info">
    <div class="panel-heading">
     <div class="panel-title">staffs List</div>
    </div>
    <div class="panel-body">
     <table class="table table-striped table-bordered">
      ...
      <c:forEach var="tempstaffs" items="${staffs}">
       ...
       <!-- construct an "update" link with staffs id -->
       <c:url var="updateLink" value="/staffs/updateForm">
        <c:param name="staffsId" value="${tempstaffs.getEmpId()}" />
       </c:url>

       <!-- construct an "delete" link with staffs id -->
       <c:url var="deleteLink" value="/staffs/delete">
        <c:param name="staffsId" value="${tempstaffs.getEmpId()}" />
       </c:url>
